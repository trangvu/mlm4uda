...
CONFIG_FILE=$SRC_PATH/experiments/config/domain-tuning-external/$DATASET_NAME'_ext_'$STRATEGY_NAME'.json'
MODEL_NAME=$DATASET_NAME"_conll2003_ext_base_"$STRATEGY_NAME
...
TASK_TUNING_MODEL_NAME=${DATASET_NAME}_ext_${STRATEGY_NAME}_${TASK_NAME}_base_cased$PREFIX
