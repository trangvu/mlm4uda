...
set -x
TASK_NAME=fin
INFILE=/scratch/da33/trang/masked-lm/data/secfiling/secfiling2019.sent.txt
OUTFILE=/projects/da33/data_nlp/named_entity_recognition/$TASK_NAME/secfiling.$TASK_NAME.sim.sorted.txt
