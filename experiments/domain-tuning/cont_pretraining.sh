...
CONFIG_FILE=$SRC_PATH/experiments/config/domain-tuning/$DATASET_NAME'_noext_'$STRATEGY_NAME'.json'
MODEL_NAME=$DATASET_NAME"_conll2003_noext_base_"$STRATEGY_NAME
