...
CONFIG_FILE=$SRC_PATH/experiments/config/domain-tuning-external-1M/$DATASET_NAME'_ext_1M_'$STRATEGY_NAME'.json'
MODEL_NAME=$DATASET_NAME"_conll2003_ext_1M_50K_base_"$STRATEGY_NAME
...
TASK_TUNING_MODEL_NAME=${DATASET_NAME}'_ext_1M_50K_'${STRATEGY_NAME}_${TASK_NAME}_base_cased$PREFIX
