...
CONFIG_FILE=$SRC_PATH/experiments/config/domain-tuning-external-100k/$DATASET_NAME'_ext_100k_'$STRATEGY_NAME'.json'
MODEL_NAME=$DATASET_NAME"_conll2003_ext_100k_base_"$STRATEGY_NAME
